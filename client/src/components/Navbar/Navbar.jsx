      ...
      {style && (
        <div className="others-display-list">
          <ul>
            ...
            {isLoggedIn ? (
              <li><button onClick={() => setStyle(!style)}><Link to="/logout">Logout</Link></button></li>
            ) : (
              <>
                <li><button onClick={() => setStyle(!style)}><Link to="/register">Register</Link></button></li>
                <li><button onClick={() => setStyle(!style)}><Link to="/login">Login</Link></button></li>
              </>
            )}
          </ul>
        </div>
      )}
      <button type="button" id="checkbars" className="nav-bars" onClick={() => setStyle(!style)}>
        <VscThreeBars />
      </button>
    </div>
  );
